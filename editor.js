...
// emblem effect. Embedded as a data URI so it works instantly with
// no network fetch and survives export (no external file dependency).
let _waterLogoImg = null;
function getWaterLogoImg() {
    if (!_waterLogoImg) {
        _waterLogoImg = new Image();
        _waterLogoImg.src = 'data:image/png;base64,';
    }
    return _waterLogoImg;
}
...
function drawWaterReflection(ctx, img, cx, topY, size, t, seed) {
    const slices = 16;
    const sliceSrcH = img.naturalHeight / slices;
    const sliceDstH = size / slices;
    for (let i = 0; i < slices; i++) {
        const destY = topY + i * sliceDstH;
        const wave = Math.sin(t * 1.3 + i * 0.5 + seed) * size * 0.03 * (i / slices + 0.3);
        const depthFade = 1 - (i / slices);
        const srcRow = slices - 1 - i;
        const sy = srcRow * sliceSrcH;
        ctx.save();
        ctx.globalAlpha = 0.32 * depthFade;
        ctx.drawImage(img, 0, sy, img.naturalWidth, sliceSrcH,
                      cx - size / 2 + wave, destY, size, sliceDstH + 1);
        ctx.restore();
    }
    const fade = ctx.createLinearGradient(0, topY, 0, topY + size);
    fade.addColorStop(0, 'rgba(8,44,62,0)');
    fade.addColorStop(1, 'rgba(8,44,62,0.95)');
    ctx.fillStyle = fade;
    ctx.fillRect(cx - size / 2, topY, size, size);
}

// Draws the emblem gently bobbing on the water surface: soft glow,
// slight rocking rotation, expanding ripple rings at the waterline,
// and a rippled reflection underneath.
function drawFloatingLogo(ctx, img, cx, baseY, size, t, seed) {
    const bobPeriod = 4.5 + (seed % 2);
    const bobAmp = size * 0.07;
    const bobPhase = t * (2 * Math.PI / bobPeriod) + seed;
    const bobY = Math.sin(bobPhase) * bobAmp;
    const rot = Math.sin(bobPhase * 0.6) * 0.06;
    const y = baseY + bobY;
    const waterLineY = baseY + size * 0.40;

    const ringCount = 3;
    for (let i = 0; i < ringCount; i++) {
        const ringPhase = (t * 0.35 + seed + i / ringCount) % 1;
        const ringR = size * 0.55 + ringPhase * size * 1.4;
        const ringAlpha = (1 - ringPhase) * 0.28;
        if (ringAlpha < 0.01) continue;
        ctx.beginPath();
        ctx.ellipse(cx, waterLineY, ringR, ringR * 0.30, 0, 0, Math.PI * 2);
        ctx.strokeStyle = `rgba(195,235,255,${ringAlpha.toFixed(3)})`;
        ctx.lineWidth = 1.4;
        ctx.stroke();
    }

    if (img.complete && img.naturalWidth) {
        drawWaterReflection(ctx, img, cx, waterLineY, size * 0.62, t, seed);
    }

    const glow = ctx.createRadialGradient(cx, y, size * 0.08, cx, y, size * 0.7);
    glow.addColorStop(0, 'rgba(255,221,140,0.30)');
    glow.addColorStop(1, 'rgba(255,221,140,0)');
    ctx.fillStyle = glow;
    ctx.beginPath();
    ctx.arc(cx, y, size * 0.7, 0, Math.PI * 2);
    ctx.fill();
    ...
    ctx.beginPath();
    ctx.ellipse(cx, waterLineY, size * 0.34, size * 0.08, 0, 0, Math.PI * 2);
    ctx.fillStyle = 'rgba(4,30,42,0.35)';
    ctx.fill();
}
...
function drawBlankPageAnimation(ctx, W, H, item, timeSec) {
    ...
    if (theme === 'space') {
        ...
        // 1) Water body gradient (deep teal at top/bottom, lighter
        //    sunlit turquoise band where the "surface" catches light)
        const waterG = ctx.createLinearGradient(0, 0, 0, H);
        waterG.addColorStop(0, '#0a2e42');
        waterG.addColorStop(0.32, '#124f6e');
        waterG.addColorStop(0.55, '#146d8f');
        waterG.addColorStop(0.8, '#0e5877');
        waterG.addColorStop(1, '#062435');
        ctx.fillStyle = waterG;
        ctx.fillRect(0, 0, W, H);

        // 2) Drifting caustic light shafts (soft diagonal glow bands,
        //    like sunlight filtering down through the water)
        for (let i = 0; i < 4; i++) {
            const cx = W * (0.1 + i * 0.28) + Math.sin(t * 0.07 + i * 1.7) * W * 0.08;
            const shaftG = ctx.createLinearGradient(cx - W * 0.16, 0, cx + W * 0.16, H);
            const shaftA = 0.05 + 0.035 * Math.sin(t * 0.4 + i);
            shaftG.addColorStop(0, 'rgba(170,235,255,0)');
            shaftG.addColorStop(0.5, `rgba(170,235,255,${shaftA.toFixed(3)})`);
            shaftG.addColorStop(1, 'rgba(170,235,255,0)');
            ctx.fillStyle = shaftG;
            ctx.fillRect(0, 0, W, H);
        }

        // 3) Rippling wave-line texture across the frame
        const rippleRows = 7;
        for (let r = 0; r < rippleRows; r++) {
            const ry = H * (0.06 + r * 0.13);
            const rspeed = 0.22 + r * 0.04;
            const ramp = 3.5 + r * 1.1;
            ctx.beginPath();
            for (let x = 0; x <= W; x += 6) {
                const yy = ry + Math.sin((x / W) * Math.PI * 4 + t * rspeed + r * 1.3) * ramp;
                if (x === 0) ctx.moveTo(x, yy); else ctx.lineTo(x, yy);
            }
            ctx.strokeStyle = `rgba(200,240,255,${(0.05 + 0.025 * Math.sin(t * 0.3 + r)).toFixed(3)})`;
            ctx.lineWidth = 1;
            ctx.stroke();
        }

        // 4) Rising light bubbles drifting up through the water
        const rngW = (seed) => { const x = Math.sin(seed * 9301 + 7919) * 23457; return x - Math.floor(x); };
        const bubbleCount = isExporting ? 10 : 18;
        for (let i = 0; i < bubbleCount; i++) {
            const seed = i;
            const bx = rngW(seed * 1.3) * W;
            const speed = 18 + rngW(seed * 2.7) * 26;
            const loop = (t / speed) % 1;
            const by = H - loop * H * 1.05;
            const br = 1 + rngW(seed * 3.1) * 2.4;
            const alpha = 0.32 * Math.sin(loop * Math.PI); // fades in, peaks mid-rise, fades out
            ctx.beginPath();
            ctx.arc(bx + Math.sin(t * 0.6 + seed) * 6, by, br, 0, Math.PI * 2);
            ctx.fillStyle = `rgba(210,245,255,${alpha.toFixed(3)})`;
            ctx.fill();
        }

        // 5) The Wings Fly emblem, floating on the surface
        const waterLogo = getWaterLogoImg();
        if (waterLogo && waterLogo.complete && waterLogo.naturalWidth) {
            const spots = [
                { fx: 0.30, fy: 0.38, sizeF: 0.24, seed: 1.1 },
                { fx: 0.74, fy: 0.64, sizeF: 0.15, seed: 4.7 },
            ];
            spots.forEach(p => {
                const size = Math.min(W, H) * p.sizeF;
                drawFloatingLogo(ctx, waterLogo, W * p.fx, H * p.fy, size, t, p.seed);
            });
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function drawFrame() {
        ...
        if (state.shapeOverlays && state.shapeOverlays.length > 0) {
            ...
            state.shapeOverlays.forEach((item) => {
                ...
                const rotation = (item.rotation || 0) + (box.pathAngle || 0);
    ...
    // repositioning) check whether a click actually belongs to one of the
    ...
    const shapeOverlayFlightPathGroup = document.getElementById('shape-overlay-flightpath-group');
    const shapeOverlayFlightPathSelect = document.getElementById('shape-overlay-flightpath');
    ...
    function showShapeOverlayControlsFor(id) {
        ...
        if (shapeOverlayFlightPathGroup) {
            shapeOverlayFlightPathGroup.style.display = (item.shapeType === 'plane') ? 'block' : 'none';
        }
        if (shapeOverlayFlightPathSelect) shapeOverlayFlightPathSelect.value = item.flightPath || 'static';
    }
    ...
    if (shapeOverlayFlightPathSelect) {
        shapeOverlayFlightPathSelect.addEventListener('change', (e) => {
            const item = state.shapeOverlays.find(s => s.id === state.selectedShapeOverlayId);
            if (item) {
                item.flightPath = e.target.value;
                drawFrame();
            }
        });
    }
    ...
    if (resetEditorBtn) {
        resetEditorBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                if (projId) {
                    deleteProjectFromStorage(projId);
                }
                localStorage.removeItem('studio_flow_active_project_id');
            } catch (e) {
